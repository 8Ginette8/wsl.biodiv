...
# 
# Description: This file contains the definition of the generic class "peval"
# as well as the associated function "pevaluate".
# Goal of the pfit class is to allow for a flexible and convenient evaluating
# of presence-only, presence/absence and abundance SDMs (currently Maxent
# GAM and VGAM are implemented).
#
#############################################################################
### =========================================================================
### Set Class
...
# generate pfit class
peval.2<-setClass("peval.2",slots=c(author="character", # Who created the object
...
### =========================================================================
# 
evalu8<-function(x,em=NA,tester=data.frame(),thres=numeric()){
